...
yum update -y
yum install gcc pcre pcre-devel zlib-devel openssl perl openssl-devel -y
cd /opt/
...
#############Bak_ApiPay_Sr############
-A INPUT -s 119.28.142.239 -j ACCEPT
#############PC_Web############
-A INPUT -s 221.150.100.89 -j ACCEPT
#############Mobile_Web
-A INPUT -s 210.91.40.64 -j ACCEPT
#############WebControl
-A INPUT -s 54.65.41.172 -j ACCEPT
#############DB_Center
-A INPUT -s 52.193.28.200 -j ACCEPT
#############Pay_Sr
-A INPUT -s 119.28.236.106 -j ACCEPT
#############PT_PClient
-A INPUT -s 150.109.233.86 -j ACCEPT
#################################################################
##            ADD_VPN_ACCESS_IP      ###
#################################################################
##         VPN_CQ                ###
-A INPUT -s 118.24.236.23 -j ACCEPT
##         VPN_CD                ###
-A INPUT -s 118.25.227.214 -j ACCEPT
##         VPN_GZ                ###
-A INPUT -s 134.175.162.246 -j ACCEPT
##         VPN_BK                ###
-A INPUT -s 192.144.162.123 -j ACCEPT
##         VPN_SH                ###
-A INPUT -s 212.64.1.93 -j ACCEPT
##########################ICMP_ACCEPT############################
